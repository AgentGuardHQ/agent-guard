...
export function generateMonster(monsterId: number, color: string, size: number): HTMLCanvasElement {
...
export function generateEgg(monsterId: number, color: string, size: number): HTMLCanvasElement {
