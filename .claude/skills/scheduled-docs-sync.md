...
```bash
git add README.md ARCHITECTURE.md CLAUDE.md ROADMAP.md
...
- **Never modify source code** — only documentation files (README.md, ARCHITECTURE.md, CLAUDE.md, ROADMAP.md)
